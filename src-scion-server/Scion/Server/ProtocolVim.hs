...
instance ToVimType CompilationResult where
  toVim cr = toVim [
      ...
      ("compilationWarnings", toVim $ concatMap errMsgToVimList (bagToList $ compilationWarnings cr)),
      ("compilationErrors", toVim $ concatMap errMsgToVimList (bagToList $ compilationErrors cr)),
